...
namespace Wordz.Web
{
    public partial class ExerciseSelectEdit : Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            submitToServerBtn.Click += new EventHandler(submitToServerBtn_Click);
            ...
            {
                Response.Write(string.Format("{{'status': 'ERR','msg': '{0}'}}", CurrentLanguage.ModuleNotDefined));
                Response.Redirect("/");
            }
        }
