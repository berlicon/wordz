...
{
    public class ExerciseSkipTextGetHandler : IHttpHandler, IRequiresSessionState
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            var details = ExerciseRelatedAccessor.GetExerciseSkipTextById(exerciseId, accountId);
            if (details == null)
            {
