...
{
    public class ExerciseSelectTextGetHandler : IHttpHandler, IRequiresSessionState
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            var details = ExerciseRelatedAccessor.GetExerciseSelectTextById(exerciseId, accountId);
            if (details == null)
            {
