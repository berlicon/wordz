...
{
    public class ExerciseAnswerTextHandler : IHttpHandler, IRequiresSessionState
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            var details = ExerciseRelatedAccessor.GetExerciseAnswerTextById(exerciseId, accountId);
            if (details == null)
            {
