...
{
    public class ExerciseSelectGetHandler : IHttpHandler, IRequiresSessionState
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            var details = ExerciseRelatedAccessor.GetExerciseSelectById(exerciseId, accountId);
            if (details == null)
            {
