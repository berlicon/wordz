...
namespace Wordz.UT {
    [TestFixture]
    public class BCCommonTest : DbTransactionalFixture {
        public BCCommonTest() {}
        ...
        public void CreateWordsCollection() {
            string text = "helper weapon helper weapon helper aback";
            ...
            WordElement abackElement = (WordElement) words["aback"];
            ...
            Assert.AreEqual("aback", abackElement.Original);
        ...
        public void ProcessText() {
            string text = "helper weapon helper weapon helper aback";
            Hashtable words = BCCommon.ProcessText(text, (int) Language.Russian, (int) Language.English);
            Assert.AreEqual(3, words.Count);
        }
        ...
        public void ShowProcessTextLearnFirstWord() {
            ...
            string expectedText =
                "aback назад" + Environment.NewLine +
                    "helper помощник" + Environment.NewLine +
                    "weapon оружие" + Environment.NewLine;
        ...
        public void ShowProcessTextNativeFirstWord() {
            ...
            string expectedText =
                "назад aback" + Environment.NewLine +
                    "оружие weapon" + Environment.NewLine +
                    "помощник helper" + Environment.NewLine;
            Assert.AreEqual(expectedText, processedText);
        }
        ...
        public void GetWordsInfoCheckMinFrequency() {
            ...
            Assert.IsNotNull(info.ProcessedWords["aback"]);
        ...
        public void GetWordsInfoCheckNotUseNotKnownWords() {
            ...
            WordElement element2 = new WordElement("weapon", "оружие", 1, 0, 0);
            words["weapon"] = element2;
        ...
        public void UpdateAccountUnicodeSymbolsTest() {
            string nick = "îăţşĂÎŞŢQW-1";
            string email = "îăţşĂÎŞŢQW-2";
            string password = "îăţşĂÎŞŢQW-3";
        ...
        public void ShowProcessTextCheckWordIds() {
            ...
            Assert.AreEqual("aback", wordIds[0].Name);
            Assert.AreEqual("назад", wordIds[0].Name2);
            Assert.AreEqual(7435, wordIds[1].Id);
            Assert.AreEqual("helper", wordIds[1].Name);
            Assert.AreEqual("помощник", wordIds[1].Name2);
            Assert.AreEqual(18183, wordIds[2].Id);
            Assert.AreEqual("weapon", wordIds[2].Name);
            Assert.AreEqual("оружие", wordIds[2].Name2);
        }
        ...
        public void GetTestedWordsHTML() {
            ...
            string result = BCCommon.GetTestedWordsHTML(pairs, false, (int) Language.Russian, (int) Language.English);
            string expectedResult =
        ...
        public void AddWordToAccount() {
            ...
            BCCommon.FillWordInfo(ref wordElement, accountId, (int) Language.Russian, (int) Language.English);
            Assert.IsFalse(wordElement.WellKnown);

            WordElement wordElement2 = new WordElement();
            wordElement2.Original = word2;
            BCCommon.FillWordInfo(ref wordElement2, accountId, (int) Language.Russian, (int) Language.English);
        ...
        public void GetVocabularyInfo() {
            ...
            int wordsCount = BCCommon.GetWordsCount((int) Language.English, (int) Language.Russian);
            info = BCCommon.GetVocabularyInfo(accountId, (int) Language.English, (int) Language.Russian);
            Assert.AreEqual("0 (0% от " + wordsCount + ")", info);
            ...
            Assert.AreEqual("1 (" + percent + "% от " + wordsCount + ")", info);
        }
        ...
        public void AddWordToDictionarySuccess() {
            ...
            BCCommon.FillWordInfo(ref wordElement, (int) Language.Russian, (int) Language.English);
            Assert.IsFalse(wordElement.ExistsInDB);

            BCCommon.AddWordToDictionary(dictionaryLine, true, (int) Language.Russian, (int) Language.English);
        ...
        public void GetTextAsHTMLForAnalysis() {
            ...
            string result = new BCCommon().GetTextAsHTMLForAnalysis(text, accountId, (int) Language.Russian, (int) Language.English, false);
            Assert.AreEqual(expected, result);
        }

        [Test]
        public void GetTextAsHTMLForAnalysisSmokeTests() {
            Assert.AreEqual("<hr>", new BCCommon().GetTextAsHTMLForAnalysis("", accountId, (int) Language.Russian, (int) Language.English, false));
            Assert.AreEqual("fdsajkleae<hr>", new BCCommon().GetTextAsHTMLForAnalysis("fdsajkleae", accountId, (int) Language.Russian, (int) Language.English, false));
            Assert.AreEqual("65!,? -<hr>", new BCCommon().GetTextAsHTMLForAnalysis("65!,? -", -1, (int) Language.Russian, (int) Language.English, false));
            Assert.AreEqual("nov th ing<hr>", new BCCommon().GetTextAsHTMLForAnalysis("nov th ing", -1, (int) Language.Russian, (int) Language.English, false));
        }
        ...
        public void GetTextAsHTMLForAnalysisPluralTime() {
            ...
            string result = new BCCommon().GetTextAsHTMLForAnalysis(text, -1, (int) Language.Russian, (int) Language.English, false);
            Assert.AreEqual(expected, result);
        }
        ...
        public void GetTestedVerbsHTML() {
            ...
            result = BCCommon.GetTestedVerbsHTML(elements, ShowColumn.Form2, (int) Language.Russian);
            expected =
                string.Format(
                    ...
                    "<input id=d{0} type=text size=29 onkeyup=\"VerbCheck('d{0}');\" v=\"{4}\" /><br>",
                elements[0].Id,
                    HttpUtility.HtmlEncode(elements[0].Form1),
                HttpUtility.HtmlEncode(elements[0].Form2),
                HttpUtility.HtmlEncode(elements[0].Form3),
                HttpUtility.HtmlEncode(elements[0].Translation));
            Assert.AreEqual(expected, result);

            result = BCCommon.GetTestedVerbsHTML(elements, ShowColumn.Random, (int) Language.Russian);
            Assert.AreEqual(expected.Length, result.Length);
        }

        [Test]
        public void GetTestedVerbsHTMLShowAllColumnsAndNativeNotRussian() {
            string result, expected;
            ...
            result = BCCommon.GetTestedVerbsHTML(elements, ShowColumn.All, (int) Language.English);
            expected =
                string.Format(
                    "<input id=w{0} type=checkbox name=w{0} />" + 
                    "<input id=a{0} type=text size=8 onkeyup=\"VerbCheck('a{0}');\" value=\"{1}\" readOnly=true />" + 
                    "<input id=b{0} type=text size=8 onkeyup=\"VerbCheck('b{0}');\" value=\"{2}\" readOnly=true />" + 
                    "<input id=c{0} type=text size=8 onkeyup=\"VerbCheck('c{0}');\" value=\"{3}\" readOnly=true />" + 
                    "<input id=d{0} type=text size=29 onkeyup=\"VerbCheck('d{0}');\" value=\"{4}\" readOnly=true /><br>",
                elements[0].Id,
                HttpUtility.HtmlEncode(elements[0].Form1),
                HttpUtility.HtmlEncode(elements[0].Form2),
                HttpUtility.HtmlEncode(elements[0].Form3),
        ...
        [Test]
        public void GetTestedVerbsHTMLShowForm1ColumnAndNativeNotRussian() {
            string result, expected;
            ...
            result = BCCommon.GetTestedVerbsHTML(elements, ShowColumn.Form1, (int) Language.English);
            expected =
                string.Format(
                    "<input id=w{0} type=checkbox name=w{0} />" + 
                    "<input id=a{0} type=text size=8 onkeyup=\"VerbCheck('a{0}');\" value=\"{1}\" readOnly=true />" + 
                    "<input id=b{0} type=text size=8 onkeyup=\"VerbCheck('b{0}');\" v=\"{2}\" />" + 
                    "<input id=c{0} type=text size=8 onkeyup=\"VerbCheck('c{0}');\" v=\"{3}\" />" + 
        ...
        public void GetWordIdByTranslation() {
            Assert.AreEqual(wordId, BCCommon.GetWordIdByTranslation(wordTranslation, (int) Language.Russian));
            Assert.AreEqual(int.MinValue, BCCommon.GetWordIdByTranslation(wordAbsentInDB, (int) Language.Russian));
        }
        ...
        public void GetDictionaryQuizHTML() {
            string content = BCCommon.GetDictionaryQuizHTML(0, (int) Language.Russian, (int) Language.English);
        ...
        public void GetDictionaryQuizResultHTML() {
            ...
            Assert.IsTrue(content.IndexOf("Поздравляем!") >= 0);

            CreateNewAccount();
            content = BCCommon.GetDictionaryQuizResultHTML(accountId, "", 0, (int) Language.English);
            pairs = BCCommon.GetTOPUsersByDictionaryQuiz((int) Language.English);
            Assert.AreEqual(length + 1, pairs.Length);
            Assert.IsTrue(content.IndexOf("Не расстраиваетесь!") >= 0);
        ...
        public void GetWordsOrderQuizHTML() {
            ...
            Assert.IsTrue(content.Length > 0);
            Assert.IsTrue(content.IndexOf("ВОПРОС:") >= 0);
            Assert.IsTrue(content.IndexOf("<div class=\"mainDivWordsOrderQuiz\"") >= 0);
            Assert.IsTrue(content.IndexOf("<span id=w") >= 0);
        }

		[Test]
		public void GetTOPUsersByLevelQuiz() {
			IdNamePair[] list = BCCommon.GetTOPUsersByLevelQuiz((int) Language.English);
			Assert.IsTrue(list.Length >= 0);
		}

		[Test]
		public void GetLevelQuizPlace() {
			int place = BCCommon.GetLevelQuizPlace(accountId, accountNick, 100, (int) Language.English);
			Assert.AreEqual(1, place);
		}

		[Test]
		public void GetLevelSentence() {
			Level level = BCCommon.GetLevelSentence((int) Language.English);
			Assert.IsNotNull(level);

			Level level2 = BCCommon.GetLevelSentence((int) Language.English);
			Assert.IsFalse(level.Sentence == level2.Sentence);
		}

        [Test]
        public void GetWordsUnsoundedShort() {
            int[] pairs = BCCommon.GetWordsUnsoundedShort((int) Language.Russian, (int) Language.English);
            Assert.AreEqual(4917, pairs.Length);
        }
        [Test]
        public void GetFilmCategories() {
            IdName[] names = BCCommon.GetFilmCategories((int) Language.Russian);
            Assert.AreEqual(11, names.Length);
            Assert.AreEqual("БОЕВИК", names[0].Name);
        }
        [Test]
        public void GetFilmsByCategory() {
            var accountId = 0;
            IdName[] categories = BCCommon.GetFilmCategories((int) Language.Russian);
            var films = BCCommon.GetFilmsByCategory(accountId, categories[0].Id, (int)Language.Russian, (int)Language.English);
        ...
        {
            var accountId = 0;
            var films = BCCommon.GetFilmsBySearch(accountId, "ali", (int) Language.Russian, (int) Language.English);
            Assert.AreEqual(6, films.Length);
            Assert.AreEqual(134, films[0].Id);
            Assert.AreEqual("Alice in Wonderland", films[0].Name);
            Assert.AreEqual("МУЛЬТФИЛЬМЫ", films[0].CategoryName);
            Assert.AreEqual(436, films[1].Id);
            Assert.AreEqual("Aliens", films[1].Name);
            Assert.AreEqual("БОЕВИК", films[1].CategoryName);
        }
        [Test]
        public void GetFilm() {
        ...
        public void GetLanguages() {
            IdName[] names = BCCommon.GetLanguages();
            Assert.IsTrue(names.Length > 0);
            Assert.IsTrue(BCCommon.GetLanguageIndex(names, (int)Language.Russian) >= 0);
            Assert.IsTrue(BCCommon.GetLanguageIndex(names, (int)Language.English) >= 0);
            Assert.IsTrue(BCCommon.GetLanguageIndex(names, (int)Language.Spanish) >= 0);
            Assert.IsTrue(BCCommon.GetLanguageIndex(names, (int)Language.German) >= 0);
            Assert.IsTrue(BCCommon.GetLanguageIndex(names, (int)Language.French) >= 0);
        }
        [Test]
        public void GetSimplifiedString() {
            string text = " (gfd) [gfd] {gfgf} aaa {trht}, bbb [gfdshf], ccc(gsg.) [gfg] {hgfdhg}";
            string simplifiedString = BCCommon.GetSimplifiedString(text);
            Assert.AreEqual("aaa, bbb, ccc", simplifiedString);
        }
        [Test]
        public void GetTextAsHTMLForAnalysisChinese() {
            string text = "镇静药名言硅酸盐水泥一一禅腈血迹斑斑";

            string result = new BCCommon().GetTextAsHTMLForAnalysis(
                text, -1, (int)Language.English, (int)Language.Chinese, false);
            
            string expected =
                BCCommon.GetWordHTML("镇静药",   14418, false) + 
                BCCommon.GetWordHTML("名言",    14206, false) + 
                BCCommon.GetWordHTML("硅酸盐水泥", 53193, false) + "一一" + 
                BCCommon.GetWordHTML("禅",        14, false) + 
                BCCommon.GetWordHTML("腈",       176, false) + 
                BCCommon.GetWordHTML("血迹斑斑",   1639, false) + "<hr>";
            Assert.AreEqual(expected, result);
        }

        [Test]
        public void GetAsianWordsHtmlChinese() {
            string text = "镇静药名言硅酸盐水泥一一禅腈血迹斑斑";
            string[] result = BCCommon.GetAsianWords(
                text, true, -1, (int)Language.English, (int)Language.Chinese);
            ...
            string expected =
                ...
                BCCommon.GetWordHTML("禅",        14, false) + 
                BCCommon.GetWordHTML("腈",       176, false) + 
                BCCommon.GetWordHTML("血迹斑斑",   1639, false);
            Assert.AreEqual(expected, result[0]);
        }

        [Test]
        public void GetAsianWordsTextChinese() {
            string text = "镇静药名言硅酸盐水泥一一禅腈血迹斑斑";
            string[] result = BCCommon.GetAsianWords(
                text, false, -1, (int)Language.English, (int)Language.Chinese);
            
            Assert.AreEqual("镇静药",   result[0]);
            Assert.AreEqual("名言",    result[1]);
            Assert.AreEqual("硅酸盐水泥", result[2]);
            Assert.AreEqual("禅",     result[3]);
            Assert.AreEqual("腈",     result[4]);
            Assert.AreEqual("血迹斑斑",  result[5]);
        }
        [Test]
        public void GetTextAsHTMLForAnalysisJapanese() {
            string text = "ちくさつばしゅうどういんちょう（）いふいじょうせいアクセスかのうばげんだいしゅうどういんごこそろばんしゅくはくせつび";

            string result = new BCCommon().GetTextAsHTMLForAnalysis(
                text, -1, (int)Language.English, (int)Language.Japanese, false);
            
            string expected =
                BCCommon.GetWordHTML("ちくさつば",       10,  false) + 
                BCCommon.GetWordHTML("しゅうどういんちょう",  12,  false) + "（）" + 
                BCCommon.GetWordHTML("いふ",          6,   false) + 
                BCCommon.GetWordHTML("いじょうせい",      33,  false) + 
                BCCommon.GetWordHTML("アクセスかのう",     100, false) + 
                BCCommon.GetWordHTML("ばげん",         80,  false) + 
                BCCommon.GetWordHTML("だいしゅうどういん",   11,  false) + 
                BCCommon.GetWordHTML("ご",           339, false) + 
                BCCommon.GetWordHTML("こ",           800, false) + 
                BCCommon.GetWordHTML("そろばん",        3,   false) + 
                BCCommon.GetWordHTML("しゅくはくせつび",    113, false) + "<hr>";
            Assert.AreEqual(expected, result);
        }

        [Test]
        public void GetAsianWordsHtmlJapanese() {
            string text = "ちくさつばしゅうどういんちょう（）いふいじょうせいアクセスかのうばげんだいしゅうどういんごこそろばんしゅくはくせつび";
            string[] result = BCCommon.GetAsianWords(
                text, true, -1, (int)Language.English, (int)Language.Japanese);
            ...
            string expected =
                ...
                BCCommon.GetWordHTML("こ",           800, false) + 
                BCCommon.GetWordHTML("そろばん",        3,   false) + 
                BCCommon.GetWordHTML("しゅくはくせつび",    113, false);
            Assert.AreEqual(expected, result[0]);
        }

        [Test]
        public void GetAsianWordsTextJapanese() {
            string text = "ちくさつばしゅうどういんちょう（）いふいじょうせいアクセスかのうばげんだいしゅうどういんごこそろばんしゅくはくせつび";
            string[] result = BCCommon.GetAsianWords(
                text, false, -1, (int)Language.English, (int)Language.Japanese);

            Assert.AreEqual("ちくさつば",        result[0]);
            Assert.AreEqual("しゅうどういんちょう",   result[1]);
            Assert.AreEqual("いふ",           result[2]);
            Assert.AreEqual("いじょうせい",       result[3]);
            Assert.AreEqual("アクセスかのう",      result[4]);
            Assert.AreEqual("ばげん",          result[5]);
            Assert.AreEqual("だいしゅうどういん",    result[6]);
            Assert.AreEqual("ご",            result[7]);
            Assert.AreEqual("こ",            result[8]);
            Assert.AreEqual("そろばん",         result[9]);
            Assert.AreEqual("しゅくはくせつび",     result[10]);
        }
    }
}