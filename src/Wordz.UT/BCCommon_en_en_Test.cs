...
namespace Wordz.UT {
    [TestFixture]
    public class BCCommon_en_en_Test : DbTransactionalFixture {
        public BCCommon_en_en_Test() {
            word = "abandon";
            word2 = "agent";
        ...
        public void ProcessText() {
            string text = "helper weapon helper weapon helper aback";
            Hashtable words = BCCommon.ProcessText(text, (int) Language.English, (int) Language.English);
            Assert.AreEqual(3, words.Count);
        }
        ...
        public void ShowProcessTextLearnFirstWord() {
            ...
            string expectedText =
                "aback aback" + Environment.NewLine +
                "helper helper" + Environment.NewLine +
        ...
        public void ShowProcessTextCheckWordIds() {
            ...
            Assert.AreEqual("helper", wordIds[1].Name2);
            Assert.AreEqual(18183, wordIds[2].Id);
            Assert.AreEqual("weapon", wordIds[2].Name);
            Assert.AreEqual("weapon", wordIds[2].Name2);
        }
        ...
        public void GetTestedWordsHTML() {
            ...
            string result = BCCommon.GetTestedWordsHTML(pairs, false, (int) Language.English, (int) Language.English);
            string expectedResult =
        ...
        public void AddWordToAccount() {
            ...
            BCCommon.FillWordInfo(ref wordElement, accountId, (int) Language.English, (int) Language.English);
            Assert.IsFalse(wordElement.WellKnown);

            WordElement wordElement2 = new WordElement();
            wordElement2.Original = word2;
            BCCommon.FillWordInfo(ref wordElement2, accountId, (int) Language.English, (int) Language.English);
        ...
        public void GetVocabularyInfo() {
            ...
            int wordsCount = BCCommon.GetWordsCount((int) Language.English, (int) Language.English);
            info = BCCommon.GetVocabularyInfo(accountId, (int) Language.English, (int) Language.English);
        ...
        public void AddWordToDictionarySuccess() {
            ...
            BCCommon.FillWordInfo(ref wordElement, (int) Language.English, (int) Language.English);
            Assert.IsFalse(wordElement.ExistsInDB);

            BCCommon.AddWordToDictionary(dictionaryLine, true, (int) Language.English, (int) Language.English);
        ...
        public void GetTextAsHTMLForAnalysis() {
            ...
            string result = new BCCommon().GetTextAsHTMLForAnalysis(text, accountId, (int) Language.English, (int) Language.English, false);
            Assert.AreEqual(expected, result);
        }

        [Test]
        public void GetTextAsHTMLForAnalysisSmokeTests() {
            Assert.AreEqual("<hr>", new BCCommon().GetTextAsHTMLForAnalysis("", accountId, (int) Language.English, (int) Language.English, false));
            Assert.AreEqual("fdsajkleae<hr>", new BCCommon().GetTextAsHTMLForAnalysis("fdsajkleae", accountId, (int) Language.English, (int) Language.English, false));
            Assert.AreEqual("65!,? -<hr>", new BCCommon().GetTextAsHTMLForAnalysis("65!,? -", -1, (int) Language.English, (int) Language.English, false));
            Assert.AreEqual("nov th ing<hr>", new BCCommon().GetTextAsHTMLForAnalysis("nov th ing", -1, (int) Language.English, (int) Language.English, false));
        }
        ...
        public void GetTextAsHTMLForAnalysisPluralTime() {
            ...
            string result = new BCCommon().GetTextAsHTMLForAnalysis(text, -1, (int) Language.English, (int) Language.English, false);
            Assert.AreEqual(expected, result);
        }
        ...
        public void GetDictionaryQuizHTML() {
            string content = BCCommon.GetDictionaryQuizHTML(0, (int) Language.English, (int) Language.English);
        ...
        public void GetWordsUnsoundedShort() {
            int[] pairs = BCCommon.GetWordsUnsoundedShort((int) Language.English, (int) Language.English);
            Assert.AreEqual(25861, pairs.Length);
        }
        [Test]
        ...
        public void GetFilmsByCategory()
        {
            ...
            var films = BCCommon.GetFilmsByCategory(accountId, categories[0].Id, (int)Language.English, (int)Language.English);
        ...
        public void GetFilmsBySearch() {
            var films = BCCommon.GetFilmsBySearch(accountId, "ali", (int) Language.English, (int) Language.English);
