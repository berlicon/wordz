...
namespace Wordz.UT {
    [TestFixture]
    public class DBCommon_en_en_Test : DbTransactionalFixture {
        public DBCommon_en_en_Test() {
            word = "abandon";
            word2 = "agent";
        ...
        public void GetWordsCount() {
            int count = DBCommon.GetWordsCount((int) Language.English, (int) Language.English);
        ...
        public void GetWordsCountSoundedFromFile() {
            int count = DBCommon.GetWordsCountSoundedFromFile((int) Language.English, (int) Language.English);
        ...
        public void FillWordInfo() {
            ...
            DBCommon.FillWordInfo(ref wordElement, accountId, (int) Language.English, (int) Language.English);
        ...
        public void GetWordInfo() {
            WordElement wordElement = DBCommon.GetWordInfo(wordId, (int) Language.English, (int) Language.English);
        ...
        public void GetWordInfoNotInDB() {
            WordElement wordElement = DBCommon.GetWordInfo(int.MinValue, (int) Language.English, (int) Language.English);
        ...
        public void FillWordsTranslation() {
            ...
            DBCommon.FillWordsTranslation(ref words, (int) Language.English, (int) Language.English);
        ...
        public void GetWordSoundFromFile() {
            byte[] sound = DBCommon.GetWordSoundFromFile(wordId, true, (int) Language.English, (int) Language.English);
            Assert.AreEqual(13882, sound.Length);
            Assert.AreEqual(0x49, sound[0]);

            sound = DBCommon.GetWordSoundFromFile(wordId, false, (int) Language.English, (int) Language.English);
            Assert.AreEqual(13882, sound.Length);
            Assert.AreEqual(0x49, sound[0]);

            sound = DBCommon.GetWordSoundFromFile(wordIdWithoutSound, true, (int) Language.English, (int) Language.English);
            Assert.AreEqual(0, sound.Length);

            sound = DBCommon.GetWordSoundFromFile(wordIdWithoutSound, false, (int) Language.English, (int) Language.English);
            Assert.AreEqual(0, sound.Length);
        }

        [Test]
        public void GetWordSoundFromFileEnglish() {
            byte[] sound = DBCommon.GetWordSoundFromFile(wordId, "", "", false, SoundingType.Learn, (int) Language.English, (int) Language.English);
            Assert.AreEqual(6941, sound.Length);
            Assert.AreEqual(0x49, sound[0]);

            sound = DBCommon.GetWordSoundFromFile(wordIdWithoutSound, "", "", false, SoundingType.Learn, (int) Language.English, (int) Language.English);
            Assert.AreEqual(0, sound.Length);
        }

        [Test]
        public void GetWordSoundFromFileRussian() {
            byte[] sound = DBCommon.GetWordSoundFromFile(wordId, "", "", false, SoundingType.Native, (int) Language.English, (int) Language.English);
            Assert.AreEqual(6941, sound.Length);
            Assert.AreEqual(0x49, sound[0]);

            sound = DBCommon.GetWordSoundFromFile(wordIdWithoutSound, "", "", false, SoundingType.Native, (int) Language.English, (int) Language.English);
            Assert.AreEqual(0, sound.Length);
        }

        [Test]
        public void GetVerbSoundFromFile() {
            byte[] sound = DBCommon.GetVerbSoundFromFile(verbId, (int) Language.English, (int) Language.English);
            Assert.AreEqual(11975 + 11975, sound.Length);
            Assert.AreEqual(0x49, sound[0]);

            sound = DBCommon.GetVerbSoundFromFile(verbIdWithoutSound, (int) Language.English, (int) Language.English);
            Assert.AreEqual(0, sound.Length);
        }
        ...
        public void GetWordIdsForDomain() {
            //TODO: write test
            IdNamePair[] pairs = DBCommon.GetWordIdsForDomain(accountId, 1, 10, 1, (int) Language.English, (int) Language.English);
            Assert.IsNotNull(pairs);
            Assert.AreEqual(10, pairs.Length);
            Assert.AreEqual("able able", pairs[0].Value);
            Assert.AreEqual("about about", pairs[1].Value);
        }
        [Test/*, Ignore("Too long test")*/]
        public void GetWordIdsRandom() {
            IdNamePair[] pairs = DBCommon.GetWordIdsRandom(accountId, 10, (int) Language.English, (int) Language.English);
            Assert.IsNotNull(pairs);
            Assert.AreEqual(10, pairs.Length);
        ...
        public void GetWordIdsOrdered() {
            IdNamePair[] pairs = DBCommon.GetWordIdsOrdered(accountId, 2, 200, (int) Language.English, (int) Language.English);
            Assert.IsNotNull(pairs);
            Assert.AreEqual("abnormity abnormity", pairs[0].Value);
            Assert.AreEqual("aboard aboard", pairs[1].Value);
        }
        [Test]
        public void GetWordIdsForAccount() {
            ...
            DBCommon.FillWordInfo(ref wordElement2, accountId, (int) Language.English, (int) Language.English);
        ...
        public void AddWordToDictionary() {
            ...
            DBCommon.FillWordInfo(ref wordElement, (int) Language.English, (int) Language.English);
            Assert.IsFalse(wordElement.ExistsInDB);

            DBCommon.AddWordToDictionary(wordElement, (int) Language.English, (int) Language.English);

            DBCommon.FillWordInfo(ref wordElement, (int) Language.English, (int) Language.English);
            Assert.IsTrue(wordElement.ExistsInDB);
            Assert.AreEqual(addedWordOriginal, wordElement.Original);
            Assert.AreEqual(addedWordOriginal, wordElement.Translation);
        }
        [Test]
        public void UpdateWordInDictionary() {
            ...
            DBCommon.UpdateWordInDictionary(wordElement, (int) Language.English, (int) Language.English);

            wordElement = DBCommon.GetWordInfo(wordElement.Id, (int) Language.English, (int) Language.English);
            Assert.AreEqual(addedWordOriginal2, wordElement.Original);
            Assert.AreEqual(addedWordOriginal2, wordElement.Translation);
        }
        [Test]
        ...
        public void GetCategories() {
            ...
            Assert.IsTrue(names.Length > 0);
            Assert.AreEqual("Study English", names[0].Name);
        }
        [Test, Ignore("No resources yet")]
        public void GetArticles() {
            Article[] articles = DBCommon.GetArticles((int) Language.English, (int) Language.English);
        ...
        public void GetTvChannels() {
            Tv[] tvs = DBCommon.GetTvChannels(BCCommon.AnonymousAccountId, (int)Language.English, (int)Language.English);
            ...
            Assert.AreEqual("Russia Today Russian online TV channel in English. Its main task to establish a foreign visitor a positive image of Russia.", tvs[0].Description);
        }
        [Test]
        public void GetTvChannel() {
            ...
            Assert.AreEqual("Russia Today Russian online TV channel in English. Its main task to establish a foreign visitor a positive image of Russia.", tv.Description);
        }
        [Test]
        public void GetFmChannels() {
            Fm[] fms = DBCommon.GetFmChannels(BCCommon.AnonymousAccountId, (int)Language.English, (int)Language.English);
            ...
            Assert.AreEqual("CNN (USA, New York) News online radio in English", fms[26].Description);
        ...
        public void GetFmChannel() {
            ...
            Assert.AreEqual("CNN (USA, New York) News online radio in English", fm.Description);
