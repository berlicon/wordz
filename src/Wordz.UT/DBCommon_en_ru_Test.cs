...
namespace Wordz.UT {
    [TestFixture]
    public class DBCommon_en_ru_Test : DbTransactionalFixture {
        public DBCommon_en_ru_Test() {
        word = "оставлять";
        word2 = "агент";
        ...
        public void GetWordsCount() {
            int count = DBCommon.GetWordsCount((int) Language.Russian, (int) Language.English);
        ...
        public void GetWordsCountSoundedFromFile() {
            int count = DBCommon.GetWordsCountSoundedFromFile((int) Language.English, (int) Language.Russian);
        ...
        public void FillWordInfo() {
            ...
            DBCommon.FillWordInfo(ref wordElement, accountId, (int) Language.English, (int) Language.Russian);
        ...
        public void GetWordInfo() {
            WordElement wordElement = DBCommon.GetWordInfo(wordId, (int) Language.English, (int) Language.Russian);
        ...
        public void GetWordInfoNotInDB() {
            WordElement wordElement = DBCommon.GetWordInfo(int.MinValue, (int) Language.English, (int) Language.Russian);
        ...
        public void AddWordToAccount() {
            ...
            DBCommon.AddWordToAccount(accountId, wordElement.Id, (int) Language.Russian);
            DBCommon.FillWordInfo(ref wordElement, accountId, (int) Language.English, (int) Language.Russian);
        ...
        public void DeleteWordFromAccount() {
            ...
            DBCommon.DeleteWordFromAccount(accountId, wordElement.Id, (int)Language.Russian);
            DBCommon.FillWordInfo(ref wordElement, accountId, (int) Language.English, (int) Language.Russian);
            Assert.IsFalse(wordElement.WellKnown);
        }
        ...
        public void FillWordsTranslation() {
            ...
            DBCommon.FillWordsTranslation(ref words, (int) Language.English, (int) Language.Russian);
...
//            fs.Close();
        ...
        public void GetWordSoundFromFile() {
            byte[] sound = DBCommon.GetWordSoundFromFile(wordId, true, (int) Language.English, (int) Language.Russian);
            Assert.AreEqual(12061, sound.Length);
            Assert.AreEqual(0xFF, sound[0]);

            sound = DBCommon.GetWordSoundFromFile(wordId, false, (int) Language.English, (int) Language.Russian);
            Assert.AreEqual(12061, sound.Length);
            Assert.AreEqual(0x49, sound[0]);

            sound = DBCommon.GetWordSoundFromFile(wordIdWithoutSound, true, (int) Language.English, (int) Language.Russian);
            Assert.AreEqual(0, sound.Length);

            sound = DBCommon.GetWordSoundFromFile(wordIdWithoutSound, false, (int) Language.English, (int) Language.Russian);
            Assert.AreEqual(0, sound.Length);
        }

        [Test]
        public void GetWordSoundFromFileEnglish() {
            byte[] sound = DBCommon.GetWordSoundFromFile(wordId, "", "", false, SoundingType.Learn, (int) Language.English, (int) Language.Russian);
            Assert.AreEqual(5120, sound.Length);
            Assert.AreEqual(0xFF, sound[0]);

            sound = DBCommon.GetWordSoundFromFile(wordIdWithoutSound, "", "", false, SoundingType.Learn, (int) Language.English, (int) Language.Russian);
            Assert.AreEqual(0, sound.Length);
        }

        [Test]
        public void GetWordSoundFromFileRussian() {
            byte[] sound = DBCommon.GetWordSoundFromFile(wordId, "", "", false, SoundingType.Native, (int) Language.English, (int) Language.Russian);
            Assert.AreEqual(6941, sound.Length);
            Assert.AreEqual(0x49, sound[0]);

            sound = DBCommon.GetWordSoundFromFile(wordIdWithoutSound, "", "", false, SoundingType.Native, (int) Language.English, (int) Language.Russian);
            Assert.AreEqual(0, sound.Length);
        }

        [Test]
        public void GetVerbSoundFromFile() {
            byte[] sound = DBCommon.GetVerbSoundFromFile(verbId, (int) Language.English, (int) Language.Russian);
            Assert.AreEqual(11975 + 12704, sound.Length);
            Assert.AreEqual(0xFF, sound[0]);

            sound = DBCommon.GetVerbSoundFromFile(verbIdWithoutSound, (int) Language.English, (int) Language.Russian);
            Assert.AreEqual(0, sound.Length);
        }

        [Test]
        public void GetDomains() {
            IdName[] names = DBCommon.GetDomains((int) Language.English);
            Assert.AreEqual(22, names.Length);
            Assert.AreEqual("popular words (956)", names[0].Name);
            Assert.AreEqual("contacts (0)", names[1].Name);
        }
        [Test]
        public void GetWordsCountForAccount() {
            ...
            count = DBCommon.GetWordsCountForAccount(accountId, (int) Language.Russian);
        ...
        public void GetWordIdsForDomain() {
            //TODO: write test
            IdNamePair[] pairs = DBCommon.GetWordIdsForDomain(accountId, 1, 10, 1, (int) Language.English, (int) Language.Russian);
            Assert.IsNotNull(pairs);
            Assert.AreEqual(10, pairs.Length);
            Assert.AreEqual("автомобиль car", pairs[0].Value);
            Assert.AreEqual("авторское право copyright", pairs[1].Value);
        }
        [Test/*, Ignore("Too long test")*/]
        public void GetWordIdsRandom() {
            IdNamePair[] pairs = DBCommon.GetWordIdsRandom(accountId, 10, (int) Language.English, (int) Language.Russian);
            Assert.IsNotNull(pairs);
            Assert.AreEqual(10, pairs.Length);
        ...
        public void GetWordIdsOrdered() {
            IdNamePair[] pairs = DBCommon.GetWordIdsOrdered(accountId, 2, 200, (int) Language.English, (int) Language.Russian);
            Assert.IsNotNull(pairs);
            Assert.AreEqual("(по)страничный; - paginal reference paginal", pairs[0].Value);
            Assert.AreEqual("(по)стучать; tap at the window стучать в окно tap at", pairs[1].Value);
        }
        [Test]
        public void GetWordIdsForAccount() {
            ...
            pairs = DBCommon.GetWordIdsForAccount(accountId, (int) Language.Russian);
            ...
            DBCommon.FillWordInfo(ref wordElement2, accountId, (int) Language.English, (int) Language.Russian);
            DBCommon.AddWordToAccount(accountId, wordElement2.Id, (int) Language.Russian);

            pairs = DBCommon.GetWordIdsForAccount(accountId, (int) Language.Russian);
            Assert.AreEqual(2, pairs.Length);
            Assert.AreEqual(wordElement.Id, pairs[0].Id);
            Assert.AreEqual(wordElement.Original, pairs[0].Name);
            Assert.AreEqual(wordElement2.Id, pairs[1].Id);
            Assert.AreEqual(wordElement2.Original, pairs[1].Name);
        }
        [Test]
        public void AddWordToDictionary() {
            ...
            DBCommon.FillWordInfo(ref wordElement, (int) Language.English, (int) Language.Russian);
            Assert.IsFalse(wordElement.ExistsInDB);

            DBCommon.AddWordToDictionary(wordElement, (int) Language.English, (int) Language.Russian);
        ...
        public void UpdateWordInDictionary() {
            ...
            wordElement.Translation = addedWordTranslation;
            DBCommon.AddWordToDictionary(wordElement, (int) Language.English, (int) Language.Russian);
            wordElement.Id = DBCommon.GetWordIdByText(wordElement.Original, (int)Language.Russian);
           
            wordElement.Original = addedWordOriginal2;
            wordElement.Translation = addedWordTranslation2;
            DBCommon.UpdateWordInDictionary(wordElement, (int) Language.English, (int) Language.Russian);

            wordElement = DBCommon.GetWordInfo(wordElement.Id, (int) Language.English, (int) Language.Russian);
        ...
        public void GetCategories() {
            IdName[] names = DBCommon.GetCategories((int) Language.English);
            Assert.IsTrue(names.Length > 0);
            Assert.AreEqual("Изучение английского", names[0].Name);
        }
        [Test, Ignore("No resources yet")]
        public void GetArticles() {
            Article[] articles = DBCommon.GetArticles((int) Language.English, (int) Language.Russian);
        ...
        public void GetTvChannels() {
            Tv[] tvs = DBCommon.GetTvChannels(BCCommon.AnonymousAccountId, (int)Language.English, (int)Language.Russian);
            ...
            Assert.AreEqual("Russia Today Pоссийский онлайн ТВ канал на английском. Его главная задача сформировать у зарубежного зрителя позитивный образ России.", tvs[0].Description);
        }
        [Test, Ignore("No resources yet")]
        public void GetTvChannel() {
            Tv tv = DBCommon.GetTvChannel(1, (int)Language.English);
            Assert.AreEqual("http://streaming.visionip.tv/Russia_Today", tv.Url);
            Assert.AreEqual("Russia Today Pоссийский онлайн ТВ канал на английском. Его главная задача сформировать у зарубежного зрителя позитивный образ России.", tv.Description);
        }
        [Test, Ignore("No resources yet")]
        public void GetFmChannels() {
            Fm[] fms = DBCommon.GetFmChannels(BCCommon.AnonymousAccountId, (int)Language.English, (int)Language.Russian);
        ...
        public void GetFmChannel() {
            Fm fm = DBCommon.GetFmChannel(27, (int)Language.English);
